% calculate error (in degress, in 2D) as a function of number of axons used
...
if indx == 1
    load('C:\Users\camil\AudSpace\Data\Decoder\All_Error.mat')
    dataset = '2-20kHz';
else
    load('C:\Users\camil\AudSpace\Data\Decoder\All_Error_80kHz.mat')
    dataset = '2-80kHz';
end
disp(dataset)
